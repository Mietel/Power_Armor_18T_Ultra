...
# Inherit from Power_Armor_18T_Ultra device
$(call inherit-product, device/ulefone/Power_Armor_18T_Ultra/device.mk)

PRODUCT_DEVICE := Power_Armor_18T_Ultra
PRODUCT_NAME := twrp_Power_Armor_18T_Ultra
PRODUCT_BRAND := Ulefone
PRODUCT_MODEL := Power Armor 18T Ultra
